...
const Webinars = ({ allWebinarsList }) => {
  // console.log("allWebinarsList has: ", allWebinarsList);
  return (
    <div className="mt-15 w-full grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 px-8 md:px-16 lg:px-20 xl:px-24 gap-x-5 gap-y-10">
      {allWebinarsList?.map((webinar) => (
        <div key={webinar.id} className="col-span-1">
          <img
            src={
              webinar.media !== "somemedialink"
                ? webinar.media
